...
const Navigation = ({ activeSection, theme, toggleTheme }) => {
  ...
  const navItems = ['Home', 'Education', 'Experience', 'Skills', 'Projects', 'Contact']
      ...
      <div className="nav-container">
        ...
        <div className="nav-right">
          ...
          <div className="nav-icons">
            ...
            <a href="https://linkedin.com/in/dineshdaki" target="_blank" rel="noopener noreferrer" className="nav-social-icon" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24" fill="currentColor">
